...
import XMonad.Actions.Promote as P (promote)
...
myStartupHook = do
    ...
    -- spawnOnce "xargs xwallpaper --stretch < ~/.xwalpaper"
    -- uncomment to set a random wallpaper on login
    spawnOnce "find /usr/share/backgrounds/husseljo-wallpapers/ -type f | shuf -n 1 | xargs xwallpaper --stretch"

    -- spawnOnce "firefox-developer-edition"
    spawnOnce "alacritty"
    spawnOnce "toggle_windows"
    -- make terminal at the left by promoting
...
myManageHook =
    composeAll
        ...
        , className =? "Xmessage" --> doCenterFloat -- Float Xmessage windows
        , appName =? "battery-low" --> doFloat -- Float low battery notification
        ]
...
myKeys =
    ...
    , ("M-<F7>", promote) -- Moves focused window to master, others maintain order
    , ("M-S-<Tab>", rotSlavesDown) -- Rotate all windows except master and keep focus in place
    , ("M-C-<Tab>", rotAllDown) -- Rotate all the windows in the current stack
    , -- KB_GROUP Layouts
      ("M-<Tab>", windows W.focusUp) -- Move focus to the prev window
