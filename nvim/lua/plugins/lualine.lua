...
return {
  ...
  config = function()
    ...
    local inactive_primary_color = {
      fg = require("lualine_utils").getColor("Normal", "bg"),
      bg = require("lualine_utils").getColor("Grey", "fg"),
    }
    ...
    require("lualine").setup({
      options = {
        theme = function()
          ...
          -- better ;)
          local colors = {
            normal = require("lualine_utils").getColor("Yellow", "fg"),
            insert = require("lualine_utils").getColor("Green", "fg"),
            visual = require("lualine_utils").getColor("Purple", "fg"),
            replace = require("lualine_utils").getColor("Red", "fg"),
            command = require("lualine_utils").getColor("Orange", "fg"),
            bg = require("lualine_utils").getColor("Normal", "bg"),
          }
      ...
      inactive_sections = {
        ...
        lualine_c = {
          ...
          },
          {
            ...
            color = { fg = require("lualine_utils").getColor("Grey", "fg") },
          },
        },
        lualine_x = {},
        lualine_y = {},
