...
import XMonad.Actions.NoBorders --added by me
...
myLayoutHook = avoidStruts $ mouseResize $ windowArrange $ T.toggleLayouts floats
             ...
             where
               myDefaultLayout =   		Full 
										withBorder myBorderWidth tall --nmaster delta ratio
                                 -- ||| magnify
                                 -- ||| noBorders monocle
                                 -- ||| floats
                                 -- ||| noBorders tabs
...
myKeys =
    ...
    -- KB_GROUP Floating windows
        ...
        , ("M-t", withFocused toggleBorder)  -- toggle border XXXXXXXXXXXXXXX
    ...
    -- KB_GROUP Layouts
        ...
        , ("M-<Space>", sendMessage NextLayout) -- goes to the next layout XXXXXXXXXXXXXXXx
